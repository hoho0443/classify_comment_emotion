...
#print(komoran.pos(u'한글형태소분석기 코모란 테스트 중 입니다.')) #형태소
...
print("train_data row : " + len(train_data))      # nrows: 150000
print("train_data col : " + len(train_data[0]))   # ncols: 3
print("test_data row : " + len(test_data))       # nrows: 50000
print("test_data col : " + len(test_data[0]))     # ncols: 3
